...
const Index = ({employees}) => {
    ...
    */
    ...
    return (
        ...
        <>
        <ModalDelete open={open} toggleModal={toggleModal} data={employeeID} routePath="employees.destroy"/>
            ...
            <div className="p-4 bg-white block sm:flex items-center justify-between border-b border-gray-200 lg:mt-1.5 dark:bg-gray-800 dark:border-gray-700">
                <div className="w-full mb-1">
                    ...
                    <div
                        ...
                        <span onClick={toggleModal} href="" id="deleteProductButton"
                        ...
                        <Button name="Add Employee" routeName="employees.create"/>
                    </div>
                </div>
            </div>
                ...
                <div className="overflow-x-auto">
                    <div className="inline-block min-w-full align-middle">
                        <div className="overflow-hidden shadow">
                            ...
                            <TableEmployee employees={employees} toggleModal={toggleModal} deleteEmployee={deleteEmployee}/>
                        </div>
                    </div>
                </div>
            </div>
