...
const Add = ({departments, positions}) => {
    ...
    function submit(event){
        ...
        router.post(route('employees.store'), {
            ...data,  forceFormData: true, _method: 'post'
        });
    };
    /*
                    ...
                    <div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                        ...
                        <form  onSubmit={submit} encType="multipart/form-data">
                            ...
                            <div className="mb-6">
                                ...
                                <textarea id="description" name="description" onChange={e => setData('description', e.target.value)} rows="4" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here...">
                                    {data.description}
                                </textarea>
