...
const Index = ({departments}) => {
    ...
    return(
        <>
            <FormModal open={open} toggleModal={toggleModal} />
            <FormModalEdit open={openEdit} toggleModal={toggleModalEdit} source={department}/>
            <ModalDelete open={openDelete} toggleModal={onModalForDelete} data={departmentId} routePath="departments.destroy"/>
