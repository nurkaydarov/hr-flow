    ...
    <div
        ...
        <div class="w-full mb-1">
            ...
            <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
                ...
                <a href='{{route('departments.create')}}' id="createProductButton"
                        ...
                        @foreach($data as $department)
                            <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="p-4 text-sm font-normal text-gray-500 whitespace-nowrap dark:text-gray-400">
                                    <div class="text-base font-semibold text-gray-900 dark:text-white">{{$department->name}}
                                    </div>
                                ...
                                <td class="p-4 space-x-2 whitespace-nowrap">
                                    <a href='{{ route('departments.edit', ['department' => $department->id]) }}' id="updateProductButton"
                                    ...
                                    <form action="{{route('departments.destroy', ['department' => $department->id])}}" method="POST" class="inline-block" >
                                        @csrf
                                        @method("DELETE")
